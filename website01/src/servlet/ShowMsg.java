...
public class ShowMsg extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageUtil<Message> pageUtil = new PageUtil<Message>();//初始化工具类
        ...
        int number = Msgdb.pageCount();//调用service层方法计算出总数据量，就是多少条数据.
        ...
        lists = Msgdb.getMsg(index);//调用service层的方法，取得数据库中的值
